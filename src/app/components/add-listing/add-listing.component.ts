  ...
  submit() {
    ...
    if (this.listingForm.valid) {
      const addListing: AddListing = {
        ...
        image: this.fileInput.nativeElement.files.length > 0 ? this.fileInput.nativeElement.files[0] : null
      };
      this.listingService.addListing(addListing).subscribe((created: ListingDetails) => {
